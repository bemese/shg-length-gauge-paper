...
in
  Ref.~\onlinecite{cabellosPRB09} where a comparison between the
...
{\color{\chon}According to Ref. ~\onlinecite{ismailPRL01}, we first
...
Refs. \onlinecite{adamsJCP53,blountSSP62}.
%%%% Valerie and Nicolas remove these lines
