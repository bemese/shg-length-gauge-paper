...
set yrange [0:1.6]
#
set ylabel "\\Large $|\\chi^{xxx}|$ (10$^5\\times$pm$^2$/V)" 
...
#
set origin 0,3
set label 1 at 2.4,1.1 '\Large$\Sigma=0\,\,\mathrm{without}\,\,\mathbf{v}^\mathrm{nl}$' 
...
set origin 0,2.25
set label 1 at 2.4,1.1 '\Large$\Sigma=0\,\,\mathrm{with}\,\,\mathbf{v}^\mathrm{nl}$' 
...
set origin 0,1.5
set label 1 at 2.4,1.1 '\Large$\hbar\Sigma=0.5\,\mathrm{eV}\,\,\mathrm{without}\,\,\mathbf{v}^\mathrm{nl}$' 
...
set label 1 at 2.4,1.1 '\Large$\hbar\Sigma=0.5\,\mathrm{eV}\,\,\mathrm{with}\,\,\mathbf{v}^\mathrm{nl}$' 
