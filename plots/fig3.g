...
#set yrange [0:1.6]
#
set ylabel "\\Large $|\\chi^{xxx}_{2\\times 1}|$ (10$^5\\times$pm$^2$/V)" 
...
set label 1 at 3.45,.5 'with $\mathbf{v}^\mathrm{nl}$'
p  'shg-results/32layers/shgC.vnl.sm_xxx_244_half-slab_10-nospin_scissor_0.5_Nc_130' u 1:(f32*shg($2,$3,$4,$5)) w l lt 1 lw 1 t '$\hbar\sigma=0.50$',\
   'shg-results/32layers/shgC.vnl.sm_xxx_244_half-slab_10-nospin_scissor_0.63_Nc_130' u 1:(f32*shg($2,$3,$4,$5)) w l lt 2 lw 2 t '$\hbar\sigma=0.63$'
